            ...
            <div className='flex flex-col justify-center items-center p-8 font-inter'>
                ...
                <div className='flex flex-wrap justify-evenly'>
                    ...
                    <div className='bg-[#0a192f] flex flex-col max-w-[400px] shadow-lg shadow-black p-5'>
                        ...
                        <a className='min-w-[122px] self-center justify-self-center border-2 p-3 hover:bg-gradient-to-r from-blue-600 to-cyan-500 hover:rounded-md duration-50' href='https://github.com/hennconnor/PlusExp' target='_blank' rel='noopener noreferrer'>Source Code</a>
                        <a className='my-2 min-w-[122px] self-center justify-self-center border-2 p-3 hover:bg-gradient-to-r from-blue-600 to-cyan-500 hover:rounded-md duration-50' href=' https://www.loom.com/share/da5e1f9b808c48148f4f182f2965b9e4?sid=d57d85a0-c89a-4cc7-a31f-b2a45eb2f552' target='_blank' rel='noopener noreferrer'>Video Demo</a>
                    </div>
                </div>
            </div>
