        ...
        <div name='projects' className='mb-64'>
            <div className='flex flex-col justify-center items-center p-8'>
                ...
                <div className='flex flex-wrap justify-evenly gap-10 text-black'>
                    <div className='bg-white rounded-md border-2 border-gray-500 flex flex-col max-w-[450px] shadow-lg shadow-black p-3'>
                    ...
                    <div className='bg-white rounded-md border-2 border-gray-500 mx-1 shadow-lg shadow-black p-3 flex flex-col max-w-[450px]'>
