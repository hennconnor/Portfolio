        ...
        <div name='projects' className='mb-64'>
            <div className='flex flex-col justify-center items-center p-8 font-poppins'>
                ...
                <div className='flex flex-wrap justify-evenly'>
                    ...
                    <div className='bg-white rounded-md border-2 border-gray-500 flex flex-col max-w-[450px] min-w-[370px] mx-1 max-h-[600px] shadow-lg shadow-black p-3'>
                        <p className='text-lg'>Plus Exp</p>
                        <img className='border-2 border-black mt-2 mx-2' src={PlusExpPic} alt='Plus Exp Project' />
                        <p className='justify-center p-5 text-center'>Created a gamified daily task planner where users gain experience points for completing tasks. Experience points are used to increase user's level with the goal to increase incentives and make the process of completing daily tasks more enjoyable.</p>
