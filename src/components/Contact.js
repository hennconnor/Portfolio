...
const Contact = () => {
    ...
    return (
        <div name='contact' className="flex flex-col justify-center items-center mb-20 font-poppins">
            ...
            <div className='flex flex-col justify-center items-center w-[85%] max-h-[600px] max-w-[800px] bg-white rounded-md border-2 border-gray-500 shadow-black shadow-lg  px-5 py-4'>
