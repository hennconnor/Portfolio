...
const Contact = () => {
    ...
    return (
        <div name='contact' className="flex flex-col justify-center items-center mb-20 font-inter">
            <p className='text-5xl mb-5'>Let's Connect!</p>
            <div className='flex flex-col justify-center items-center w-[85%] max-w-[400px] bg-[#0a192f] shadow-black shadow-lg p-10'>
                ...
                <form ref={myRef} className='flex flex-col p-5 w-full text-black' action='https://getform.io/f/cb6288aa-aa41-4da0-a612-e3f677d74712' method="POST">
                    ...
                    <button className='my-2 p-2 border-2 text-white hover:bg-gradient-to-r from-blue-600 to-cyan-500 hover:rounded-md duration-50' type='submit' onSubmit={resetForm}>Send Message</button>
                </form>
            </div>
        </div >
    )
