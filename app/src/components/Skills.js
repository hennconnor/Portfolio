    ...
    return (
        <div name='skills' className="bg-[#0d1e39] w-full h-screen font-mono">
            <div className='text-white flex flex-col w-max-[1000px] mx-[100px] justify-start h-full px-5'>
                ...
                <Link className='self-center' to='projects' spy={true} smooth={true} offset={-150} duration={500} ><button className='flex items-center max-w-[200px] max-h-[100px] text-xl border-2 px-2 py-2 my-2'>View Projects<BsArrowDownCircle /></button></Link>
            </div>
